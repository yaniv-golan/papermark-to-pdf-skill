...
3. `papermark-to-pdf/.claude-plugin/plugin.json` — `"version"` field
...
6. `papermark-to-pdf/skills/*/SKILL.md` — `metadata.version` in YAML frontmatter
7. `papermark-to-pdf/skills/*/VERSION` — copied from root
